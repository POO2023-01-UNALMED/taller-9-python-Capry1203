...
########### Bind #############33
boton_1.bind("<Button-1>",inicio); boton_2.bind("<Button-1>",inicio)
boton_3.bind("<Button-1>",inicio); boton_4.bind("<Button-1>",inicio)
boton_5.bind("<Button-1>",inicio); boton_6.bind("<Button-1>",inicio)
boton_7.bind("<Button-1>",inicio); boton_8.bind("<Button-1>",inicio)
boton_9.bind("<Button-1>",inicio); boton_punto.bind("<Button-1>",inicio)
boton_mas.bind("<Button-1>",inicio); boton_menos.bind("<Button-1>",inicio)
boton_multiplicacion.bind("<Button-1>",inicio); boton_division.bind("<Button-1>",inicio)
boton_igual.bind("<Button-1>",operaciones)

############ Grid ############3333
boton_1.grid(row=1, column=0, padx=1, pady=1); boton_2.grid(row=1, column=1, padx=1, pady=1)
boton_3.grid(row=1, column=2, padx=1, pady=1) ; boton_4.grid(row=2, column=0, padx=1, pady=1)
boton_5.grid(row=2, column=1, padx=1, pady=1) ; boton_6.grid(row=2, column=2, padx=1, pady=1)
boton_7.grid(row=3, column=0, padx=1, pady=1) ; boton_8.grid(row=3, column=1, padx=1, pady=1)
boton_9.grid(row=3, column=2, padx=1, pady=1) ; boton_mas.grid(row=1, column=3, padx=1, pady=1)
boton_menos.grid(row=2, column=3, padx=1, pady=1) ; boton_multiplicacion.grid(row=3, column=3, padx=1, pady=1)
boton_division.grid(row=4, column=3, padx=1, pady=1) ; boton_igual.grid(row=4, column=0, columnspan=2, padx=1, pady=1)
